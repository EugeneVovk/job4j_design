 ...
 * <p>
 * JAXB (Java Architecture for XML Building) -
 * позволяет связывать xml-схемы с java-объектами.
 ...
 * <p>
 * Маршалинг (от англ. marshal — упорядочивать) — процесс преобразования информации
 * (данных, двоичного представления объекта), хранящейся в оперативной памяти,
 * в формат (xml), пригодный для хранения или передачи.
 * Процесс похож на сериализацию.
 */
